...
import { ArrowRight, Code2, Database, Cpu, Leaf, BarChart3, Globe } from 'lucide-react';
    ...
    const features = [
        {
            ...
            description: "Using mathematical models to simulate and predict ecosystem dynamics and biodiversity patterns."
        },
        {
            icon: <Code2 className="h-6 w-6 text-white" />,
            title: "Software Development",
            description: "Creating custom software tools and algorithms for processing complex environmental data."
        },
        {
            icon: <Database className="h-6 w-6 text-white" />,
            title: "Digital Base Construction",
            description: "Building a comprehensive digital foundation for storing and analyzing multi-source ecological data."
        }
    ];

    const stats = [
        { value: "17", label: "Team Members", icon: <Globe className="h-5 w-5" /> },
        { value: "5+", label: "Software Tools", icon: <Cpu className="h-5 w-5" /> },
        { value: "10+", label: "Datasets", icon: <Database className="h-5 w-5" /> },
        { value: "100%", label: "Open Source", icon: <Code2 className="h-5 w-5" /> }
    ];
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden -z-10 pointer-events-none">
                <div className="absolute top-20 left-10 w-64 h-64 bg-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    >
                        <div className="inline-flex items-center px-4 py-2 rounded-full glass mb-8 animate-float border border-primary-200">
                            <span className="w-2 h-2 rounded-full bg-green-500 mr-2"></span>
                            <span className="text-sm font-medium text-secondary-600">Managed by Dept. of Math & CS, Hetao College</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                            <Link to="/resources" className="px-8 py-4 bg-primary-600 text-white rounded-xl font-semibold shadow-lg shadow-primary-600/30 hover:bg-primary-700 hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2">
